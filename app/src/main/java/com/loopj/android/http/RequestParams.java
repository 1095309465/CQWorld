...
public class RequestParams implements Serializable {
	 ...
	 * 
	 * @param encoding
	 *        String constant from {@link HTTP}
	 */
	 ...
	 * 
	 * @param force
	 *        boolean, should declare content-type multipart/form-data even without files or streams present
	 */
	 ...
	 * 
	 * @param keysAndValues
	 *        a sequence of keys and values. Objects are automatically converted to Strings (including the value {@code null}).
	 ...
	 *         if one of passed files is not found at time of assembling the requestparams into request
	 */
